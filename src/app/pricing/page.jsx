  ...
  return (
    <>
      ...
      <div className="w-full relative">
        ...
        <div className="w-full h-[800px] bg-pricing bg-cover bg-center bg-no-repeat"></div>

        <div className="bg-theme-skyBlue">
          <div className="flex justify-center items-center gap-24 h-[197px]">
            <div className="flex gap-2 items-center">
              <img src="/images/pricing/24h.png" alt="24h image" />
              <p className="font-sf font-medium text-xl text-theme-brightBlue">
                Free 24h delivery
              </p>
            </div>
            <div className="flex gap-2 items-center">
        ...
        <div className="w-full max-w-[1290px] mx-auto px-[16px] sm:px-[45px] py-[100px]">
          <div className="w-full grid grid-cols-2 gap-10">
            ...
            { !isLoading ? data?.data?.serviceData?.map((item) => {
              return item?.id === 1 ? (
                <CategoryCard
